...
async function startApp() {
  ...
  const { AdditionalIntlMessages, LanguageToFiatCurrency } = await import(
    "./config.ui"
  );
  const { LoadingIndicatorProvider } = await import(
    "@components/loading-indicator"
  );
  const { NotificationProvider, NotificationStoreProvider } = await import(
    "@components/notification"
  );
  const { ConfirmProvider } = await import("@components/confirm");
  const { DropdownContextProvider } = await import(
    "@components-v2/dropdown/dropdown-context"
  );
  ...
  const { InExtensionMessageRequester } = await import(
    "@keplr-wallet/router-extension"
  );
  ...
  const { ActivityDetails } = await import(
    "./pages-new/activity/activity-details"
  );
  const { IBCTransferPage } = await import("./pages-new/more/ibc-transfer");
  const { AccessPage, Secret20ViewingKeyAccessPage } = await import(
    "./pages/access"
  );
  const { BridgePage } = await import("./pages-new/bridge");
  const { BridgeHistoryView } = await import(
    "./pages-new/bridge/bridge-history"
  );
  ...
  const { SettingConnectionsPage, SettingSecret20ViewingKeyConnectionsPage } =
    await import("./pages-new/more/security-privacy/connections");
  const { AddressBookPage } = await import("./pages-new/more/address-book");
  const { ExportToMobilePage } = await import(
    "./pages-new/more/export-to-mobile"
  );
  const { FetchnameService } = await import("./pages/fetch-name-service");
  const { DomainDetails } = await import(
    "./pages/fetch-name-service/domain-details"
  );
  ...
  const { AutoLockPage } = await import(
    "./pages-new/more/security-privacy/autolock"
  );
  const { SecurityPrivacyPage } = await import(
    "./pages-new/more/security-privacy"
  );
  const { SignPageV2 } = await import("./pages-new/sign");
  const { ICNSAdr36SignPage } = await import("./pages/icns/sign");
  const { ApproveAddChainByNetworkPage } = await import(
    "./pages/approveAddChainByNetwork"
  );
  const { ApproveSwitchChainPage } = await import(
    "./pages/approveSwitchChainPage"
  );
  const { ApproveSwitchAccountByAddressPage } = await import(
    "./pages/approveSwitchAccountPage"
  );
  const { AxelarBridgeEVM } = await import(
    "./pages/axelar-bridge/axelar-bridge-evm"
  );
  const { AxelarBridgeCosmos } = await import(
    "./pages/axelar-bridge/axelar-bridge-cosmos"
  );
  const { GrantGlobalPermissionGetChainInfosPage } = await import(
    "./pages/permission/grant"
  );
  const { PermissionsGetChainInfosPage } = await import(
    "./pages-new/more/security-privacy/permissions/get-chain-infos"
  );
  ...
  const { NotificationOrganizations } = await import(
    "./pages-new/more/notification/notiphy-notification/notification-organizations"
  );
  const { NotificationTopics } = await import(
    "./pages-new/more/notification/notiphy-notification/notification-topics"
  );
  const { ReviewNotification } = await import(
    "./pages-new/more/notification/notiphy-notification/review-notification"
  );
  ...
  const { CreateGroupChat } = await import(
    "./pages/group-chat/create-group-chat"
  );
  ...
  const { ProposalDetail } = await import(
    "./pages-new/more/proposals/proposal-details"
  );
  ...
  const { KeyRingStatus } = await import(
    "@keplr-wallet/background/src/keyring/keyring"
  );
  const { StartAutoLockMonitoringMsg } = await import(
    "@keplr-wallet/background/src/auto-lock-account/messages"
  );
  ...
  const StateRenderer = observer(() => {
    ...
    if ((keyRingStore.status as any) === 0) {
                        ...
                        React.createElement(
                          ...
                          React.createElement(
                            ...
                            React.createElement(Route, {
                              path: "/",
                              element: React.createElement(StateRenderer),
                            }),
                            React.createElement(Route, {
                              path: "/unlock",
                              element: React.createElement(LockPage),
                            }),
                            React.createElement(Route, {
                              path: "/access",
                              element: React.createElement(AccessPage),
                            }),
                            React.createElement(Route, {
                              path: "/access/viewing-key",
                              element: React.createElement(
                                Secret20ViewingKeyAccessPage
                              ),
                            }),
                            React.createElement(Route, {
                              path: "/activity-details",
                              element: React.createElement(ActivityDetails),
                            }),
                            React.createElement(Route, {
                              path: "/register",
                            ...
                            React.createElement(Route, {
                              path: "/send",
                              element: React.createElement(SendPage),
                            }),
                            React.createElement(Route, {
                              path: "/ibc-transfer",
                              element: React.createElement(IBCTransferPage),
                            }),
                            React.createElement(Route, {
                              path: "/bridge",
                              element: React.createElement(BridgePage),
                            }),
                            React.createElement(Route, {
                              path: "/bridge-history",
                              element: React.createElement(BridgeHistoryView),
                            }),
                            React.createElement(Route, {
                              path: "/setting",
                            ...
                            React.createElement(Route, {
                              ...
                              element: React.createElement(
                                KeystoneImportPubkeyPage
                              ),
                            }),
                            React.createElement(Route, {
                              path: "/keystone/sign",
                              element: React.createElement(KeystoneSignPage),
                            }),
                            React.createElement(Route, {
                              path: "/more",
                              element: React.createElement(MorePage),
                            }),
                            React.createElement(Route, {
                              path: "/more/language",
                              element: React.createElement(MoreLanguagePage),
                            }),
                            React.createElement(Route, {
                              path: "/more/export/:index",
                              element: React.createElement(ExportPage),
                            }),
                            React.createElement(Route, {
                              path: "/more/currency",
                              element: React.createElement(CurrencyPge),
                            }),
                            React.createElement(Route, {
                            ...
                            React.createElement(Route, {
                              ...
                              element: React.createElement(AddressBookPage),
                            }),
                            React.createElement(Route, {
                              path: "/activity",
                              element: React.createElement(ActivityPage),
                            }),
                            React.createElement(Route, {
                              path: "/more/export-to-mobile",
                              element: React.createElement(ExportToMobilePage),
                            }),
                            React.createElement(Route, {
                              path: "/fetch-name-service/:tab",
                              element: React.createElement(FetchnameService),
                            }),
                            React.createElement(Route, {
                              path: "/fetch-name-service/domain-details/:domain",
                              element: React.createElement(DomainDetails),
                            }),
                            React.createElement(Route, {
                              path: "/setting/set-keyring",
                              element: React.createElement(SetKeyRingPage),
                            }),
                            React.createElement(Route, {
                              path: "/setting/clear/:index",
                              element: React.createElement(DeleteWallet),
                            }),
                            React.createElement(Route, {
                              path: "/setting/keyring/change/name/:index",
                              element: React.createElement(ChangeNamePageV2),
                            }),
                            React.createElement(Route, {
                              path: "/more/token/add",
                              element: React.createElement(AddTokenPage),
                            }),
                            React.createElement(Route, {
                              path: "/more/token/moonpay",
                              element: React.createElement(BuySellTokenPage),
                            }),
                            React.createElement(Route, {
                              path: "/more/token/manage",
                              element: React.createElement(ManageTokenPage),
                            }),
                            React.createElement(Route, {
                              path: "/setting/endpoints",
                              element:
                                React.createElement(SettingEndpointsPage),
                            }),
                            React.createElement(Route, {
                              path: "/more/security-privacy/autolock",
                              element: React.createElement(AutoLockPage),
                            }),
                            React.createElement(Route, {
                              path: "/more/security-privacy",
                              element: React.createElement(SecurityPrivacyPage),
                            }),
                            React.createElement(Route, {
                              path: "/sign",
                              element: React.createElement(SignPageV2),
                            }),
                            React.createElement(Route, {
                              path: "/icns/adr36-signatures",
                              element: React.createElement(ICNSAdr36SignPage),
                            }),
                            React.createElement(Route, {
                              path: "/suggest-chain",
                              element: React.createElement(ChainActivePage),
                            }),
                            React.createElement(Route, {
                              path: "/add-chain-by-network",
                              element: React.createElement(
                                ApproveAddChainByNetworkPage
                              ),
                            }),
                            React.createElement(Route, {
                              path: "/switch-chain-by-chainid",
                              element: React.createElement(
                                ApproveSwitchChainPage
                              ),
                            }),
                            React.createElement(Route, {
                              path: "/switch-account-by-address",
                              element: React.createElement(
                                ApproveSwitchAccountByAddressPage
                              ),
                            }),
                            React.createElement(Route, {
                              path: "/axl-bridge-evm",
                              element: React.createElement(AxelarBridgeEVM),
                            }),
                            React.createElement(Route, {
                              path: "/axl-bridge-cosmos",
                              element: React.createElement(AxelarBridgeCosmos),
                            }),
                            React.createElement(Route, {
                            ...
                            React.createElement(Route, {
                              path: "/authz",
                              element: React.createElement(AuthZPage),
                            }),
                            React.createElement(Route, {
                              path: "/notification",
                              element: React.createElement(NotificationPage),
                            }),
                            React.createElement(Route, {
                            ...
                            React.createElement(Route, {
                              ...
                              element: React.createElement(NotificationTopics),
                            }),
                            React.createElement(Route, {
                              path: "/notification/review",
                              element: React.createElement(ReviewNotification),
                            }),
                            React.createElement(Route, {
                              path: "/chat",
                            ...
                            React.createElement(Route, {
                              path: "/chat/:name",
                              element: React.createElement(ChatSection),
                            }),
                            React.createElement(Route, {
                              path: "/new-chat",
                              element: React.createElement(NewChat),
                            }),
                            React.createElement(Route, {
                              path: "/chat/group-chat/create",
                              element: React.createElement(CreateGroupChat),
                            }),
                            React.createElement(Route, {
                              path: "/chat/group-chat/add-member",
                              element: React.createElement(AddMember),
                            }),
                            React.createElement(Route, {
                              path: "/chat/group-chat/edit-member",
                              element: React.createElement(EditMember),
                            }),
                            React.createElement(Route, {
                              path: "/chat/group-chat/review-details",
                              element: React.createElement(ReviewGroupChat),
                            }),
                            React.createElement(Route, {
                              path: "/chat/group-chat-section/:name",
                              element: React.createElement(GroupChatSection),
                            }),
                            React.createElement(Route, {
                              path: "/chat/agent/:name",
                              element: React.createElement(AgentChatSection),
                            }),
                            React.createElement(Route, {
                              path: "/more/notifications",
                              element: React.createElement(MoreNotifications),
                            }),
                            React.createElement(Route, {
                              path: "/setting/chat",
                              element: React.createElement(ChatSettings),
                            }),
                            React.createElement(Route, {
                              path: "/setting/chat/block",
                              element: React.createElement(BlockList),
                            }),
                            React.createElement(Route, {
                            ...
                            React.createElement(Route, {
                              ...
                              element: React.createElement(ReadRecipt),
                            }),
                            React.createElement(Route, {
                              path: "/validators/:validator_address/:operation",
                              element: React.createElement(Validator),
                            }),
                            React.createElement(Route, {
                              path: "/proposal",
                              element: React.createElement(Proposals),
                            }),
                            React.createElement(Route, {
                              path: "/proposal-detail/:id",
                              element: React.createElement(ProposalDetail),
                            }),
                            React.createElement(Route, {
                              path: "/setting/addEvmChain",
                              element: React.createElement(AddEvmChain),
                            }),
                            React.createElement(Route, {
                              path: "/receive",
                              element: React.createElement(Receive),
                            }),
                            React.createElement(Route, {
                              path: "/portfolio",
                            ...
                            React.createElement(Route, {
                              path: "/asset",
                              element: React.createElement(AssetView),
                            }),
                            React.createElement(Route, {
                              path: "/manage-networks",
                              element: React.createElement(ManageNetworks),
                            }),
                            React.createElement(Route, {
                              path: "/stake",
                              element: React.createElement(Stake),
                            }),
                            React.createElement(Route, {
                            ...
                            React.createElement(Route, {
                              ...
                              element: React.createElement(Redelegate),
                            }),
                            React.createElement(Route, {
                              path: "/validator/validator-list",
                              element: React.createElement(ValidatorListPage),
                            }),
                            React.createElement(Route, {
                              path: "/validator/:validator_address/delegate",
                              element: React.createElement(Delegate),
                            }),
                            React.createElement(Route, {
                              path: "/validator/:validator_address/unstake",
                              element: React.createElement(Unstake),
                            }),
                            React.createElement(Route, {
                              path: "*",
                              element: React.createElement(StateRenderer),
