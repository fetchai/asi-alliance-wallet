...
export class RootStore {
  ...
  constructor() {
    ...
    this.keyRingStore = new KeyRingStore(
      {
        dispatchEvent: (type: string) => {
          ...
          if (type === "fetchwallet_walletstatuschange" || type === "keplr_walletstatuschange") {
            try {
              ...
              const isLockUnlockTransition =
                ...
                (currentStatus === 1 /* KeyRingStatus.LOCKED */ || currentStatus === 2 /* KeyRingStatus.UNLOCKED */) &&
    ...
    autorun(async () => {
      const walletIds = this.keyRingStore.multiKeyStoreInfo.map((ks) => ks.meta?.["__id__"] || "");
      // eslint-disable-next-line @typescript-eslint/no-var-requires
      const { addressCacheStore } = require("../utils/address-cache-store");
      ...
      const hasWalletListChanged = currentSet.size !== lastWalletIds.size ||
      ...
      for (const chainId of allChainIds) {
        await addressCacheStore.atomicCacheUpdate(chainId, (currentCache: AddressCacheById) => {
