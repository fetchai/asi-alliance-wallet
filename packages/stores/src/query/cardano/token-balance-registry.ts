...
import { ObservableQueryCardanoTokenBalanceInner, ObservableQueryCardanoTokenBalance } from "./token-balance";
 ...
 */
export class ObservableQueryCardanoTokenBalanceRegistry implements BalanceRegistry {
  constructor(
  ...
  getBalanceInner(
    ...
    const tokenBalanceQuery = this.getSharedQuery
      ...
      : new ObservableQueryCardanoTokenBalance(this.kvStore, chainId, chainGetter, bech32Address);
